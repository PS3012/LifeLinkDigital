  ...
  return (
    <div className="top_container m-3">
      <div className="service_headingr">
        <h1 className="heading">Paper less microbiology</h1>
      </div>
        ...
        <div className="container">
          <div className="row g-5 align-items-center">
            ...
            <div className="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
              <h4 className="why_line">The Paperless Potion:</h4>
      ...
      <div className="bottom_line_container">
        <h5 className="bottom_line">Ready to ditch the paper and embrace the digital revolution?</h5>
      </div>
    </div>
  );
}
