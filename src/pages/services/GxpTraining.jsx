  ...
  return (
    <div className="top_container m-5">
      <div className="service_headingr">
        <h1 className="heading">GxP Training </h1>
      </div>

      <div className="bottom_line_container">
        <h5 className="bottom_line">GxP Compliance Training for Regulated Pharma Companies: A Detailed Summary</h5>
      </div>
      ...
      <h4 className="why_line">Objectives:</h4>
      <div className="content_container">
        <ul className="list-group">
          ...
          <li className="list-group-item">Foster a culture of quality and compliance within the organization.</li>
        </ul>
      </div>
      <h4 className="why_line mt-5">Course Modules:</h4>
      <div className="content_container">
        <ul>
          <li>
      ...
      <h4 className="why_line mt-5">Benefits:</h4>
      <div className="content_container">
        <ul className="list-group">
          <li className="list-group-item">
      ...
      <h4 className="why_line mt-5">Delivery Options:</h4>
      <div className="content_container">
        <ul className="list-group">
          <li className="list-group-item">
      ...
      <h4 className="why_line mt-5">Additional Considerations:</h4>
      <div className="content_container">
        <ul className="list-group">
          <li className="list-group-item">
            <b>Customization: </b>
