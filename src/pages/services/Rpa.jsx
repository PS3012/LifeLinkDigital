  ...
  return (
    <div className="top_container m-5">
      ...
      <div className="bottom_line_container">
        <h5 className="bottom_line">Robotic Process Automation (RPA) in Pharma Companies: A Detailed Summary</h5>
      </div>
        ...
        <div className="container">
          <div className="row g-5 align-items-center">
            ...
            <div className="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
              <h4 className="why_line">Why Use RPA in Pharma?</h4>
      ...
      <div className="container-fluid py-5">
        <div className="container">
          <div className="row g-5 align-items-center">
            <div className="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
              <h4 className="why_line mt-5">Key Applications of RPA in Pharma:</h4>
              <div className="content_container">
                <ul>
                  <li>
      ...
      <div className="container-fluid section2 py-5">
        <div className="container">
          <div className="row g-5 align-items-center">
            ...
            <div className="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
              <h4 className="why_line mt-5">Benefits of RPA:</h4>
              <div className="content_container">
                <ul>
                  <li>
      ...
      <div className="container-fluid py-5">
        <div className="container">
          <div className="row g-5 align-items-center">
            <div className="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
              <h4 className="why_line mt-5">Challenges of RPA:</h4>
              <div className="content_container">
                <ul>
                  <li>
      ...
      <div className="container-fluid section2 py-5">
        <div className="container">
          <div className="row g-5 align-items-center">
            ...
            <div className="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
              <h4 className="why_line mt-5">Additional Notes:</h4>
              <div className="content_container">
                <ul>
                  <li>
                    <b>What is it?</b>
