...
function Feature() {
    return (
        <>
            ...
            <BreadCrumb page="Features" />

            {/* <!-- Feature Start --> */}
            <div className="container-fluid bg-dark feature pt-5">
                <div className="container pt-5">
                    <div className="row g-5">
                        <div className="col-lg-6 align-self-center mb-md-5 pb-md-5 wow fadeIn">
                            ...
                            <div className="d-flex align-items-center text-white mb-3">
                                <div className="btn-sm-square bg-white text-themeColor rounded-circle me-3">
                                    <FontAwesomeIcon icon={faCheck} />
                                </div>
                                <span>Diam dolor diam ipsum et tempor sit</span>
                            </div>
